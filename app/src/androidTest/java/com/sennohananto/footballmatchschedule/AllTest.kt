...
//        appCompatCheckedTextView.perform(click())
        ...
        onView(withId(R.id.recvPrevMatch)).perform(
                RecyclerViewActions.actionOnItemAtPosition<ViewHolder>(3, click()));
...
//        recyclerView9.perform(actionOnItemAtPosition<ViewHolder>(1, click()))
        ...
        onView(withId(R.id.recvFavoriteMatches)).perform(
                RecyclerViewActions.actionOnItemAtPosition<ViewHolder>(1, click()));
...
//        recyclerView10.perform(actionOnItemAtPosition<ViewHolder>(0, click()))
        ...
        onView(withId(R.id.recvFavoriteTeam)).perform(
